...
namespace isc.time.report.be.api.Controllers.v1.TimeReports
{
    ...
    public class TimeReportController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportToExcel([FromQuery] int employeeId, [FromQuery] int year, [FromQuery] int month)
        {
            var fileBytes = await _timeReportService.GenerateExcelReportAsync(employeeId, year, month);
