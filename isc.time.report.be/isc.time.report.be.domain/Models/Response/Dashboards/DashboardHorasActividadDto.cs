...
namespace isc.time.report.be.domain.Models.Response.Dashboards
{
    ...
    public record DashboardRecursosPendientesDto(int EmployeeID, string NombreCompletoEmpleado, decimal HorasRegistradasMes, int TotalDiasHabilesMes, int DiasConReporte, int DiasOchoHorasCumplidas, int DiasPendientes, int MesConsulta, int AnioConsulta);
