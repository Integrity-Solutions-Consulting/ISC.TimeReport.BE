...
namespace isc.time.report.be.domain.Models.Response.Dashboards
{
    ...
    public record DashboardRecursosPendientesDto(int EmployeeID, string NombreCompletoEmpleado, decimal HorasRegistradasPeriodo, int TotalDiasHabilesPeriodo, int DiasConReporte, int DiasOchoHorasCumplidas, int DiasPendientes, int MesConsulta, int AnioConsulta, string TipoConsulta);
